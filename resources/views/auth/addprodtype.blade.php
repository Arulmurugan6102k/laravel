...
<div class="row justify-content-center mt-5">
    <div class="col-md-12 col-md-12 shadow-lg bg-body" style="border-radius:18px;">
        <div class="p-5">
            <div class="text-center h1 mb-4">ADD PRODUCT TYPE</div>
            <div class="card-body ">
                <form action="{{ route('products.type.store') }}" method="post" id="product-form">
                    @csrf
            </div>
            <div class="row">
            ...
            <div class="d-flex justify-content-center ">
                ...
                <script>
                    document.getElementById('cancelButton').onclick = function () {
                        window.location.href = "{{ route('showprodtype') }}";
                    };
                </script>
            </div>
            </form>
