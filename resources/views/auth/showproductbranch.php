                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <button href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left: -13;">Manage</button>
                        </a>
                        <!-- Dropdown - User Information -->
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in text-center" aria-labelledby="userDropdown">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="img-profile rounded-circle" src="http://localhost/userloginregister/resources/images/undraw_profile.svg ">
                        </a>
                        <!-- Dropdown - User Information -->
            ...
            <div class="card-header py-3 d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-center">
                    <div class="d-flex justify-content-center">
                        ...
                        <div>
                        <button class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left: 16px;height: 37.22222px;width: 170px;">
                                <a style="text-decoration: none; color: inherit;" href="http://localhost/test/userloginregister/productsbranches/create">
                                <span><i class="fas fa-add"></i></span>
                                Add Product Branch</a></button><a style="text-decoration: none; color: inherit;" href="http://localhost/test/userloginregister/productsbranches/create">
                            </a>
                        </div>
                    </div>
                </div>
...
</body><!-- Bootstrap core JavaScript--></html>